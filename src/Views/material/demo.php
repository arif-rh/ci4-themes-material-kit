  <div class="page-header header-filter clear-filter purple-filter" data-parallax="true" style="background-image: url('<?= $theme_url ?>assets/img/bg2.jpg');">
    <div class="container">
      <div class="row">
  ...
  <div class="main main-raised">
    ...
    <div class="section section-navbars cd-section" id="navigation">
      ...
      <!--             navbar -->
      <div id="navbar">
        <div class="navigation-example" style="background-image: url('<?= $theme_url ?>assets/img/bg.jpg');">
                  ...
                  <li class="dropdown nav-item">
                    <a href="javascript:;" class="profile-photo dropdown-toggle nav-link" data-toggle="dropdown">
                      <div class="profile-photo-small">
                        <img src="<?= $theme_url ?>assets/img/faces/avatar.jpg" alt="Circle Image" class="rounded-circle img-fluid">
                      </div>
                    </a>
                    <div class="dropdown-menu dropdown-menu-right">
                      <h6 class="dropdown-header">Dropdown header</h6>
      ...
      <div class="container tim-container">
        ...
        <div id="images">
          ...
          <div class="row">
            <div class="col-sm-2">
              <h4>Rounded Image</h4>
              <img src="<?= $theme_url ?>assets/img/faces/avatar.jpg" alt="Rounded Image" class="rounded img-fluid">
            </div>
            ...
            <div class="col-sm-2 ml-auto">
              ...
              <img src="<?= $theme_url ?>assets/img/faces/avatar.jpg" alt="Raised Image" class="img-raised rounded img-fluid">
            </div>
            <div class="col-sm-2 ml-auto">
              <h4>Circle Raised</h4>
              <img src="<?= $theme_url ?>assets/img/faces/avatar.jpg" alt="Thumbnail Image" class="img-raised rounded-circle img-fluid">
            </div>
          </div>
          <div class="row">
          </div>
              ...
              <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" data-interval="3000">
                ...
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img class="d-block w-100" src="<?= $theme_url ?>assets/img/bg2.jpg" alt="First slide">
                  ...
                  <div class="carousel-item">
                    <img class="d-block w-100" src="<?= $theme_url ?>assets/img/bg3.jpg" alt="Second slide">
                    <div class="carousel-caption d-none d-md-block">
                      <h4>
                        <i class="material-icons">location_on</i>
                  ...
                  <div class="carousel-item">
                    <img class="d-block w-100" src="<?= $theme_url ?>assets/img/bg.jpg" alt="Third slide">
                    <div class="carousel-caption d-none d-md-block">
                      <h4>
                        <i class="material-icons">location_on</i>
                        Yellowstone National Park, United States
    ...
    <div class="section section-signup page-header" style="background-image: url('<?= $theme_url ?>assets/img/city.jpg');">
      <div class="container">
        <div class="row">
    ...
    <div class="col-md-12 text-center">
      <a href="<?=  site_url('material/login') ?>" class="btn btn-link btn-primary btn-lg" target="_blank">View Login Page</a>
    </div>
    <div class="section section-examples">
      <div class="container-fluid text-center">
        <div class="row">
          <div class="col-md-6">
            <a href="<?=  site_url('material/landing') ?>" target="_blank">
              <img src="<?= $theme_url ?>assets/img/landing.jpg" alt="Rounded Image" class="img-raised rounded img-fluid">
              <button class="btn  btn-link btn-primary btn-lg">View Landing Page</button>
            </a>
          </div>
          <div class="col-md-6">
            <a href="<?=  site_url('material/profile') ?>" target="_blank">
              <img src="<?= $theme_url ?>assets/img/profile.jpg" alt="Rounded Image" class="img-raised rounded img-fluid">
